    ...
    <div style={{ paddingTop: '80px' }} className="dashboard">
      ...
      <div className="measurement-card">
        ...
        <ul style={{ marginTop: '1rem', marginLeft: '0' }}>
          <li>Расчёт неопределённости измерений (тип A и B)</li>
          <li>Статистическая обработка результатов измерений</li>
          <li>Построение градуировочных зависимостей</li>
          <li>Визуализация результатов измерений</li>
          <li>Экспорт отчётов в PDF и Excel</li>
          <li>Ведение базы данных измерений</li>
        </ul>
      </div>
    </div>
  );
